...
do {
    ...
    function main() {
        ...
        if (coordinates_array.length === 2) { // Check if the array has a length of 2
            ...
            if (latitude > 90 || latitude < -90 || LETTER_REGEX.test(latitude) || longitude > 180 || longitude < -180 || LETTER_REGEX.test(longitude)) {
                // console.error("Line 41: Out of bounds for latitude and/or longitude or latitude and/or longitude contains letters")
                coordinateError();
            } else {
            ...
            // console.error("Line 51: More than 2 values inside coordinates_array");
            coordinateError();
        }
    } // End of main()
    ...
    if (coordinates.includes(",")) {
        ...
        // console.log("Line 69: Does not contain comma, not a coordinate");
        coordinateError();
    }
